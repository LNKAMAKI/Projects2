 ...
 //console.log(segs)
   ...
   okentao = 0
    for (okentao in divs) {
             ...
             //   console.log(monomios[segs[anchor].mons[high]].numero,army)
                ...
                if (pain.length == 0 || pain.search('([0-9]|[a-z)])') == -1) {
                 ...
                 //       console.log('ERRADO', '2*x')
                   ...
                   console.log('UY',uy)
                   if(uy.search('\\-') != -1) {
                       console.log('EIIIIIIIIIIIIIIII, NÃO VAI NAÃO!')
                        holdon = ''
                        for (foryou in uy) {
                            console.log(uy[foryou])
                            if (uy[foryou] != '-') {
                                holdon+= uy[foryou]
                            }
                        }
                   ...
                   console.log('PAIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIINNNNNNNNNNNNNNNNNNNNNNNNNNNNNN', uy)
       ...
       for (ah in scarecrow) {
           console.log('_____________________', scarecrow[ah].divididos)
